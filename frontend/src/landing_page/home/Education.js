    ...
    return ( 
        <div className="container mt-5">
            <div className='row'>
                ...
                <p className="mt-5">TradingQ&A, the most active trading and investment community in India for all your market related queries. <br></br>covering everything from the basics to advanced trading.</p>
